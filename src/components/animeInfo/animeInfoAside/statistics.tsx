...
export default function Statistics({ animeData }: { animeData: IsAnimeData }) {
  ...
  const { score, scored_by, rank, popularity, members, favorites } = animeData;
  return (
    <article className="pt-6">
      ...
      >
        <li>
          <span className="font-medium">Score:</span> {score || "None"} (scored
          by {scored_by >= 1 ? scored_by.toLocaleString("en") : "0"} users)
        </li>
        <li>
