...
import { IReviews } from "@/types/sectionInterfaces/reviewsInterface";
  ...
  return (
    ...
    >
      ...
      <div className="text-[12px] ml-2 relative">
        ...
        <p className="absolute right-0 top-0 text-[12px] opacity-60">{date}</p>
        {review.tags && (
          <button
            type="button"
    ...
    ${readMore ? "" : "line-clamp-4"} `}
        ...
        <div className="flex px-3 mt-2 items-center gap-16">
          <div className="flex items-center gap-2 ">
            ...
            <p className="opacity-60 pt-[2px]">{review.reactions.overall}</p>
          </div>
